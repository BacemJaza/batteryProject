...
function BatteryMaterialAndCompositionForm() {
  ...
  const [showMaterialUseForm, setShowMaterialUseForm] = useState(true);
  ...
  const toggleMaterialUseForm = () => {
    setShowMaterialUseForm(!showMaterialUseForm);
  };
  ...
  return (
    <div className='flex-col justify-center p-10'>
      ...
      <div className='flex mx-auto justify-between w-[50%] mb-5'>
        <h2 className="text-2xl font-bold">Material used in cathode, anode, and electrolytes</h2>
        <button onClick={toggleMaterialUseForm} className='w-fit rounded-full bg-[#D1D5DB] text-white hover:bg-gray-500 p-2'>
            {showMaterialUseForm ? (
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
